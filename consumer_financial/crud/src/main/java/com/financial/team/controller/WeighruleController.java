...
public class WeighruleController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('team:weighrule:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{tId}")
    @PreAuthorize("hasAuthority('team:weighrule:info')")
    public Resp<WeighruleEntity> info(@PathVariable("tId") Integer tId){
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('team:weighrule:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('team:weighrule:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('team:weighrule:delete')")
